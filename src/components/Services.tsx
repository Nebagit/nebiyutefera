...
const Services = () => {
  const services = [
    ...
    },
    {
      ...
      description:
        "Cutting-edge AI solutions for business automation and intelligent decision making.",
      features: [
    ...
    },
    {
      ...
      description:
        "Scalable cloud solutions designed for performance, security, and cost efficiency.",
      features: [
    ...
    },
    {
      ...
      description:
        "Strategic technology guidance to help businesses make informed decisions.",
      features: [
    ...
    },
    {
      ...
      description:
        "Innovative research in AI and computer science for academic and commercial applications.",
      features: [
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-gray-300 max-w-3xl mx-auto">
          I am Leading expert-driven teams to deliver comprehensive software and
          tech solutions; turning your ideas and projects into powerful and
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        {services.map((service, index) => (
          <div
            key={index}
            className="group bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-blue-500/40 hover:bg-white/10 transition-all duration-500 transform hover:scale-105 hover:shadow-2xl relative"
            style={{
          ...
          >
            {/* Service Icon */}
          <div
  className="w-16 h-16 bg-blue-500/20 rounded-2xl flex items-center justify-center text-2xl mb-6 group-hover:scale-110 transition-transform duration-300"
>
  {React.cloneElement(service.icon, { color: "#3b82f6" })} {/* #3b82f6 is blue-400 */}
</div>
            ...
            <ul className="space-y-3">
              {service.features.map((feature, featureIndex) => (
                ...
                >
                  <CheckCircle2 className="w-4 h-4 text-cyan-400 mt-1 mr-3 flex-shrink-0" />
                  {feature}
                </li>
              ))}
            </ul>
